...
snakemake <- Snakemake(
    ...
    output = list('matrix/group_ip_melted/align-tes/Spom_normRPM/h3k36me2_Spom_normRPM_align-tes_meltedmat.txt', 'plots/metagene/group_ip_div_none/align-tes/Spom_normRPM/h3k36me2_Spom_normRPM_align-tes_metagene.png', "matname" = 'matrix/group_ip_melted/align-tes/Spom_normRPM/h3k36me2_Spom_normRPM_align-tes_meltedmat.txt', "plotname" = 'plots/metagene/group_ip_div_none/align-tes/Spom_normRPM/h3k36me2_Spom_normRPM_align-tes_metagene.png'),
