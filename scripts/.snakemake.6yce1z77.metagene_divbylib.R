...
snakemake <- Snakemake(
    ...
    output = list('plots/metagene/group_ip_div_lib/align-tss/Spom_normRPM/ha_Spom_normRPM_align-tss_div_input_metagene.png'),
    ...
    wildcards = list('align-tss', 'Spom', 'RPM', 'ha', 'input', "annotation" = 'align-tss', "species" = 'Spom', "norm" = 'RPM', "ip" = 'ha', "control" = 'input'),
    threads = 1,
    log = list(),
    resources = list(),
