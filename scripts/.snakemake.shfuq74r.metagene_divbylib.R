...
snakemake <- Snakemake(
    ...
    output = list('plots/metagene/group_ip_div_lib/align-tss/Spom_normRPM/h3_Spom_normRPM_align-tss_div_input_metagene.png'),
    ...
    wildcards = list('align-tss', 'Spom', 'RPM', 'h3', 'input', "annotation" = 'align-tss', "species" = 'Spom', "norm" = 'RPM', "ip" = 'h3', "control" = 'input'),
    threads = 1,
    log = list(),
    resources = list(),
