...
snakemake <- Snakemake(
    ...
    output = list('plots/metagene/group_ip_div_lib/align-tes/Scer_normSI/pol2_Scer_normSI_align-tes_div_input_no_spt6_metagene.png'),
    ...
    wildcards = list('align-tes', 'Scer', 'SI', 'pol2', 'input_no_spt6', "annotation" = 'align-tes', "species" = 'Scer', "norm" = 'SI', "ip" = 'pol2', "control" = 'input_no_spt6'),
    threads = 1,
    log = list(),
    resources = list(),
