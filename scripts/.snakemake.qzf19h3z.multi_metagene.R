...
snakemake <- Snakemake(
    input = list('matrix/align-tss/group_ip/Scer_normSI/h3k36me3_Scer_normSI_align-tss.tsv.gz', "mat" = 'matrix/align-tss/group_ip/Scer_normSI/h3k36me3_Scer_normSI_align-tss.tsv.gz'),
    output = list('matrix/group_ip_melted/align-tss/Scer_normSI/h3k36me3_Scer_normSI_align-tss_meltedmat.txt', 'plots/metagene/group_ip_div_none/align-tss/Scer_normSI/h3k36me3_Scer_normSI_align-tss_metagene.png', "matname" = 'matrix/group_ip_melted/align-tss/Scer_normSI/h3k36me3_Scer_normSI_align-tss_meltedmat.txt', "plotname" = 'plots/metagene/group_ip_div_none/align-tss/Scer_normSI/h3k36me3_Scer_normSI_align-tss_metagene.png'),
    params = list(20, 300, 4000, 0, 'TSS', "binsize" = 20, "upstream" = 300, "downstream" = 4000, "bodylength" = 0, "align" = 'TSS'),
    wildcards = list('align-tss', 'Scer', 'SI', 'h3k36me3', "annotation" = 'align-tss', "species" = 'Scer', "norm" = 'SI', "ip" = 'h3k36me3'),
    threads = 1,
    log = list(),
    resources = list(),
