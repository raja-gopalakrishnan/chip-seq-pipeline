...
snakemake <- Snakemake(
    input = list('matrix/align-tes/group_ip/Scer_normRPM/ha_Scer_normRPM_align-tes.tsv.gz', "mat" = 'matrix/align-tes/group_ip/Scer_normRPM/ha_Scer_normRPM_align-tes.tsv.gz'),
    output = list('matrix/group_ip_melted/align-tes/Scer_normRPM/ha_Scer_normRPM_align-tes_meltedmat.txt', 'plots/metagene/group_ip_div_none/align-tes/Scer_normRPM/ha_Scer_normRPM_align-tes_metagene.png', "matname" = 'matrix/group_ip_melted/align-tes/Scer_normRPM/ha_Scer_normRPM_align-tes_meltedmat.txt', "plotname" = 'plots/metagene/group_ip_div_none/align-tes/Scer_normRPM/ha_Scer_normRPM_align-tes_metagene.png'),
    params = list(20, 4000, 300, 0, 'TES', "binsize" = 20, "upstream" = 4000, "downstream" = 300, "bodylength" = 0, "align" = 'TES'),
    wildcards = list('align-tes', 'Scer', 'RPM', 'ha', "annotation" = 'align-tes', "species" = 'Scer', "norm" = 'RPM', "ip" = 'ha'),
    threads = 1,
    log = list(),
    resources = list(),
