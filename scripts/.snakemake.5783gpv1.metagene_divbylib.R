...
snakemake <- Snakemake(
    ...
    output = list('plots/metagene/group_ip_div_lib/align-tss/Scer_normRPM/pol2_Scer_normRPM_align-tss_div_input_no_spt6_metagene.png'),
    ...
    wildcards = list('align-tss', 'Scer', 'RPM', 'pol2', 'input_no_spt6', "annotation" = 'align-tss', "species" = 'Scer', "norm" = 'RPM', "ip" = 'pol2', "control" = 'input_no_spt6'),
    threads = 1,
    log = list(),
    resources = list(),
