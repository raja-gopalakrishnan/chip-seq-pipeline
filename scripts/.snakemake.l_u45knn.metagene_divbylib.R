...
snakemake <- Snakemake(
    ...
    output = list('plots/metagene/group_ip_div_lib/align-tss/Spom_normRPM/h3k36me2_Spom_normRPM_align-tss_div_input_no_spt6_metagene.png'),
    ...
    wildcards = list('align-tss', 'Spom', 'RPM', 'h3k36me2', 'input_no_spt6', "annotation" = 'align-tss', "species" = 'Spom', "norm" = 'RPM', "ip" = 'h3k36me2', "control" = 'input_no_spt6'),
    threads = 1,
    log = list(),
    resources = list(),
