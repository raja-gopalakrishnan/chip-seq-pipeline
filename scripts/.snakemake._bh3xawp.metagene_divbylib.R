...
snakemake <- Snakemake(
    ...
    output = list('plots/metagene/group_ip_div_lib/align-tss/Scer_normRPM/h3k36me2_Scer_normRPM_align-tss_div_input_metagene.png'),
    ...
    wildcards = list('align-tss', 'Scer', 'RPM', 'h3k36me2', 'input', "annotation" = 'align-tss', "species" = 'Scer', "norm" = 'RPM', "ip" = 'h3k36me2', "control" = 'input'),
    threads = 1,
    log = list(),
    resources = list(),
