...
snakemake <- Snakemake(
    input = list('matrix/align-tes/group_ip/Spom_normSI/h3_Spom_normSI_align-tes.tsv.gz', "mat" = 'matrix/align-tes/group_ip/Spom_normSI/h3_Spom_normSI_align-tes.tsv.gz'),
    output = list('matrix/align-tes/group_ip_melted/Spom_normSI/h3_Spom_normSI_align-tes_meltedmat.txt', 'plots/multi_metagene/align-tes/group_ip/Spom_normSI/h3_Spom_normSI_align-tes_metagene.png', "matname" = 'matrix/align-tes/group_ip_melted/Spom_normSI/h3_Spom_normSI_align-tes_meltedmat.txt', "plotname" = 'plots/multi_metagene/align-tes/group_ip/Spom_normSI/h3_Spom_normSI_align-tes_metagene.png'),
    params = list(20, 4000, 300, 0, 'TES', "binsize" = 20, "upstream" = 4000, "downstream" = 300, "bodylength" = 0, "align" = 'TES'),
    wildcards = list('align-tes', 'Spom', 'SI', 'h3', "annotation" = 'align-tes', "species" = 'Spom', "norm" = 'SI', "ip" = 'h3'),
    threads = 1,
    log = list(),
    resources = list(),
