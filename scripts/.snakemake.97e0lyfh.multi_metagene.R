...
snakemake <- Snakemake(
    ...
    output = list('matrix/group_ip_melted/align-tss/Spom_normRPM/input_Spom_normRPM_align-tss_meltedmat.txt', 'plots/metagene/group_ip_div_none/align-tss/Spom_normRPM/input_Spom_normRPM_align-tss_metagene.png', "matname" = 'matrix/group_ip_melted/align-tss/Spom_normRPM/input_Spom_normRPM_align-tss_meltedmat.txt', "plotname" = 'plots/metagene/group_ip_div_none/align-tss/Spom_normRPM/input_Spom_normRPM_align-tss_metagene.png'),
