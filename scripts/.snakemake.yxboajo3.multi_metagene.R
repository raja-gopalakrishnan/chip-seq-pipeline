...
snakemake <- Snakemake(
    ...
    output = list('matrix/group_ip_melted/align-tes/Spom_normSI/h3_Spom_normSI_align-tes_meltedmat.txt', 'plots/metagene/group_ip_div_none/align-tes/Spom_normSI/h3_Spom_normSI_align-tes_metagene.png', "matname" = 'matrix/group_ip_melted/align-tes/Spom_normSI/h3_Spom_normSI_align-tes_meltedmat.txt', "plotname" = 'plots/metagene/group_ip_div_none/align-tes/Spom_normSI/h3_Spom_normSI_align-tes_metagene.png'),
