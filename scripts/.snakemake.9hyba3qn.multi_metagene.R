...
snakemake <- Snakemake(
    input = list('matrix/align-tes/group_ip/Spom_normRPM/h3k36me2_Spom_normRPM_align-tes.tsv.gz', "mat" = 'matrix/align-tes/group_ip/Spom_normRPM/h3k36me2_Spom_normRPM_align-tes.tsv.gz'),
    output = list('matrix/align-tes/group_ip_melted/Spom_normRPM/h3k36me2_Spom_normRPM_align-tes_meltedmat.txt', 'plots/multi_metagene/align-tes/group_ip/Spom_normRPM/h3k36me2_Spom_normRPM_align-tes_metagene.png', "matname" = 'matrix/align-tes/group_ip_melted/Spom_normRPM/h3k36me2_Spom_normRPM_align-tes_meltedmat.txt', "plotname" = 'plots/multi_metagene/align-tes/group_ip/Spom_normRPM/h3k36me2_Spom_normRPM_align-tes_metagene.png'),
    params = list(20, 4000, 300, 0, 'TES', "binsize" = 20, "upstream" = 4000, "downstream" = 300, "bodylength" = 0, "align" = 'TES'),
    wildcards = list('align-tes', 'Spom', 'RPM', 'h3k36me2', "annotation" = 'align-tes', "species" = 'Spom', "norm" = 'RPM', "ip" = 'h3k36me2'),
    threads = 1,
    log = list(),
    resources = list(),
...
Cairo(plotname, type="png", width=10, height=5, units = "in", dpi = 300)
print(g)
dev.off()
