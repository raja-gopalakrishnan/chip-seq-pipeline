...
snakemake <- Snakemake(
    ...
    output = list('matrix/group_ip_melted/align-tss/Scer_normSI/h3_Scer_normSI_align-tss_meltedmat.txt', 'plots/metagene/group_ip_div_none/align-tss/Scer_normSI/h3_Scer_normSI_align-tss_metagene.png', "matname" = 'matrix/group_ip_melted/align-tss/Scer_normSI/h3_Scer_normSI_align-tss_meltedmat.txt', "plotname" = 'plots/metagene/group_ip_div_none/align-tss/Scer_normSI/h3_Scer_normSI_align-tss_metagene.png'),
