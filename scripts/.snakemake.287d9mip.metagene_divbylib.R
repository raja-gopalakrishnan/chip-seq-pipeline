...
snakemake <- Snakemake(
    ...
    output = list('plots/metagene/group_ip_div_lib/align-tes/Spom_normRPM/h3k36me3_Spom_normRPM_align-tes_div_input_no_spt6_metagene.png'),
    ...
    wildcards = list('align-tes', 'Spom', 'RPM', 'h3k36me3', 'input_no_spt6', "annotation" = 'align-tes', "species" = 'Spom', "norm" = 'RPM', "ip" = 'h3k36me3', "control" = 'input_no_spt6'),
    threads = 1,
    log = list(),
    resources = list(),
