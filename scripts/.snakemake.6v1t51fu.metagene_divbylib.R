...
snakemake <- Snakemake(
    ...
    output = list('plots/metagene/group_ip_div_lib/align-tss/Spom_normSI/h3k36me2_Spom_normSI_align-tss_div_input_metagene.png'),
    ...
    wildcards = list('align-tss', 'Spom', 'SI', 'h3k36me2', 'input', "annotation" = 'align-tss', "species" = 'Spom', "norm" = 'SI', "ip" = 'h3k36me2', "control" = 'input'),
    threads = 1,
    log = list(),
    resources = list(),
