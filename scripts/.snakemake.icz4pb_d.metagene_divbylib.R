...
snakemake <- Snakemake(
    ...
    output = list('plots/metagene/group_ip_div_lib/align-tes/Scer_normSI/h3k36me2_Scer_normSI_align-tes_div_input_no_spt6_metagene.png'),
    ...
    wildcards = list('align-tes', 'Scer', 'SI', 'h3k36me2', 'input_no_spt6', "annotation" = 'align-tes', "species" = 'Scer', "norm" = 'SI', "ip" = 'h3k36me2', "control" = 'input_no_spt6'),
    threads = 1,
    log = list(),
    resources = list(),
