...
snakemake <- Snakemake(
    ...
    output = list('plots/metagene/group_ip_div_lib/align-tss/Spom_normSI/h3k36me3_Spom_normSI_align-tss_div_input_no_spt6_metagene.png'),
    ...
    wildcards = list('align-tss', 'Spom', 'SI', 'h3k36me3', 'input_no_spt6', "annotation" = 'align-tss', "species" = 'Spom', "norm" = 'SI', "ip" = 'h3k36me3', "control" = 'input_no_spt6'),
    threads = 1,
    log = list(),
    resources = list(),
